...
class FragmentCaregiverUpdateBookingAppointment: BaseFragment<FragmentCaregiverUpdateBookingAppointmentBinding, FragmentCaregiverUpdateBookingAppointmentViewModel>(),
    FragmentCaregiverUpdateBookingAppointmentNavigator {
    private var fragmentNursesBookingAppointmentBinding: FragmentCaregiverUpdateBookingAppointmentBinding? = null
    private var fragmentNursesBookingAppointmentViewModel: FragmentCaregiverUpdateBookingAppointmentViewModel? = null
    ...
    override val viewModel: FragmentCaregiverUpdateBookingAppointmentViewModel
        get() {
            fragmentNursesBookingAppointmentViewModel =
                ViewModelProviders.of(this).get(FragmentCaregiverUpdateBookingAppointmentViewModel::class.java!!)
...
//        apiHitForNurseHourlySlot()
        ...
        fragmentNursesBookingAppointmentBinding?.txtSelectSlotOrHour?.setOnClickListener(View.OnClickListener {
            CommonDialog.showDialogForDropDownList(this!!.activity!!,"Select Time",nationalityDropdownlist,object:
...
//                    fra?.imgRootscareProfileImage?.setImageBitmap(bitmap)
    ...
    fun saveImage(myBitmap: Bitmap): String {
        ...
        val wallpaperDirectory = File(
            (Environment.getExternalStorageDirectory()).toString() + FragmentCaregiverUpdateBookingAppointment.IMAGE_DIRECTORY)
