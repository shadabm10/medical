...
class AdapterCaregiverSpecilityListRecyclerview (val departmentList: ArrayList<DepartmentItem?>?, internal var context: Context) : RecyclerView.Adapter<AdapterCaregiverSpecilityListRecyclerview.ViewHolder>() {
