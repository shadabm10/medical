...
class AdapterDoctorCategoriesLisingRecyclerview ( internal var context: Context) : RecyclerView.Adapter<AdapterDoctorCategoriesLisingRecyclerview.ViewHolder>() {
...
//
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val singleItemDashboardListingBinding = DataBindingUtil.inflate<ItemRootscareDoctorCategorilistingRecyclerviewBinding>(
...
//        return trainerList!!.size
    ...
    inner class ViewHolder(itemView: ItemRootscareDoctorCategorilistingRecyclerviewBinding) : RecyclerView.ViewHolder(itemView.root) {

        private var local_position:Int = 0
        init {
            itemView?.root?.btn_rootscare_booking_doctor?.setOnClickListener(View.OnClickListener {
