...
class AdapterPhysiotherapyCategoryLisytingRecyclerview ( internal var context: Context) : RecyclerView.Adapter<AdapterPhysiotherapyCategoryLisytingRecyclerview.ViewHolder>() {
...
//
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val singleItemDashboardListingBinding = DataBindingUtil.inflate<ItemPhysiotherapyCategoryListingRecyclerviewBinding>(
...
//        return trainerList!!.size
    ...
    inner class ViewHolder(itemView: ItemPhysiotherapyCategoryListingRecyclerviewBinding) : RecyclerView.ViewHolder(itemView.root) {
