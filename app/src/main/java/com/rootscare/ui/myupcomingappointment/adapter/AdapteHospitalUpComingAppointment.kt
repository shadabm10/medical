...
class AdapteHospitalUpComingAppointment(val pathologyAppointmentList: ArrayList<PathologyAppointmentItem?>?, internal var context: Context) : RecyclerView.Adapter<AdapteHospitalUpComingAppointment.ViewHolder>() {
...
//        return trainerList!!.size
    ...
    inner class ViewHolder(itemView: ItemMyUpcomingappointmentRecyclerviewBinding) : RecyclerView.ViewHolder(itemView.root) {
        ...
        fun onBind(pos: Int) {
            ...
            if(pathologyAppointmentList?.get(pos)?.appointmentDate!=null && !pathologyAppointmentList?.get(pos)?.appointmentDate.equals("")){
