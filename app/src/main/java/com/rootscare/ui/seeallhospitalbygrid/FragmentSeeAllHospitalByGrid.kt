...
class FragmentSeeAllHospitalByGrid : BaseFragment<FragmentSeeAllHospitalListBinding, FragmentSeeAllHospitalByGridViewModel>(),
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fragmentSeeAllDoctorByGridBinding?.btnRootscareNearbyHospital?.setOnClickListener(View.OnClickListener {
...
*/
        ...
        fragmentSeeAllDoctorByGridBinding?.txFiter?.setOnClickListener(View.OnClickListener {
...
//        setupSpecialitySpinner()
        ...
        fragmentSeeAllDoctorByGridBinding?.txtSearchHospital?.addTextChangedListener(object : TextWatcher {
...
// yourEditText...
            ...
            override fun onTextChanged(
             ...
             //   if(s.toString().length>3){
                    if(isNetworkConnected){
                        ...
                        seeAllDoctorSearch?.searchContent=fragmentSeeAllDoctorByGridBinding?.txtSearchHospital?.text?.toString()
    ...
    private fun setUpViewSeeAllDoctorByGridlistingRecyclerview(allDoctorList: ArrayList<HospitalResultItem?>?) {
        ...
        val recyclerView = fragmentSeeAllDoctorByGridBinding!!.recyclerViewRootscareSeeallhospitalList
        val gridLayoutManager = GridLayoutManager(activity, 2, GridLayoutManager.VERTICAL, false)
        recyclerView.layoutManager = gridLayoutManager
        recyclerView.setHasFixedSize(true)
        val contactListAdapter = AdapterSeeAllHospitalByGridRecyclerView(allDoctorList,context!!)
    ...
    override fun successAllDoctorListingResponse(allDoctorListingResponse: AllHospitalListingResponse?) {
        ...
        if(allDoctorListingResponse?.code.equals("200")){
            if(allDoctorListingResponse?.result!=null && allDoctorListingResponse?.result.size>0){
                fragmentSeeAllDoctorByGridBinding?.recyclerViewRootscareSeeallhospitalList?.visibility=View.VISIBLE
                ...
                fragmentSeeAllDoctorByGridBinding?.recyclerViewRootscareSeeallhospitalList?.visibility=View.GONE
