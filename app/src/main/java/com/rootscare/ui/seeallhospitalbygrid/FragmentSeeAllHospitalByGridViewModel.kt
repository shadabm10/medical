...
class FragmentSeeAllHospitalByGridViewModel : BaseViewModel<FragmentSeeAllHospitalByGridNavigator>() {
...
//        val body = RequestBody.create(MediaType.parse("application/json"), "")
    ...
    fun apidoctorlist() {
//        val body = RequestBody.create(MediaType.parse("application/json"), "")
        val disposable = apiServiceWithGsonFactory.apihospitallist()
            .subscribeOn(_scheduler_io)
            .observeOn(_scheduler_ui)
            .subscribe({ response ->
                if (response != null) {
...
//        val body = RequestBody.create(MediaType.parse("application/json"), "")
        val disposable = apiServiceWithGsonFactory.apidepartmenthospitallist(doctorListByDepartmentIdRequestBody)
            .subscribeOn(_scheduler_io)
            .observeOn(_scheduler_ui)
            .subscribe({ response ->
                if (response != null) {
