...
import com.rootscare.databinding.ItemNotificationRecyclerviewBinding
import com.rootscare.interfaces.OnItemClikWithIdListener
import com.rootscare.ui.home.subfragment.adapter.AdapterHospitalRecyclerviw
import com.rootscare.ui.myupcomingappointment.adapter.AdapteMyUpComingAppointment

class AdapterNotificationListRecyclerview ( internal var context: Context) : RecyclerView.Adapter<AdapterNotificationListRecyclerview.ViewHolder>() {
...
//
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val singleItemDashboardListingBinding = DataBindingUtil.inflate<ItemNotificationRecyclerviewBinding>(
            LayoutInflater.from(context),
            R.layout.item_notification_recyclerview, parent, false)
...
//        return trainerList!!.size
    ...
    inner class ViewHolder(itemView: ItemNotificationRecyclerviewBinding) : RecyclerView.ViewHolder(itemView.root) {
