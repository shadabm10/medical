...
class AdapterHospitalAppointmentlistRecyclerview (val pathologyAppointmentList: ArrayList<PathologyAppointmentItem?>?, internal var context: Context) : RecyclerView.Adapter<AdapterHospitalAppointmentlistRecyclerview.ViewHolder>() {
