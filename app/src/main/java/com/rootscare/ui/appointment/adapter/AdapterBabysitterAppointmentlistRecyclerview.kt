...
class AdapterBabysitterAppointmentlistRecyclerview  (val babysitterAppointmentList: ArrayList<BabysitterAppointmentItem?>?, internal var context: Context) : RecyclerView.Adapter<AdapterBabysitterAppointmentlistRecyclerview.ViewHolder>() {
    companion object {
