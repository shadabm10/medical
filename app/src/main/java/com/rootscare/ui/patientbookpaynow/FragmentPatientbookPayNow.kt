...
import com.rootscare.ui.bookingappointment.FragmentBookingAppointmentViewModel
import com.rootscare.ui.home.HomeActivity
import com.rootscare.ui.home.subfragment.HomeFragment

class FragmentPatientbookPayNow : BaseFragment<FragmentPatientBookingPaynowBinding, FragmentPatientbookPayNowViewModel>(), FragmentPatientbookPayNowNavigator {
    ...
    companion object {
        ...
        override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
            ...
            fragmentPatientBookingPaynowBinding?.btnBookingPayNow?.setOnClickListener(View.OnClickListener {
                CommonDialog.showDialog(this.activity!!, object :
                    ...
                    override fun onConfirm() {
                        (activity as HomeActivity).checkFragmentInBackstackAndOpen(HomeFragment.newInstance())
