...
class NoInternetActivity  : BaseActivity<ActivityNoInternetBinding, NoInternetViewModel>(), NoInternetNavigator,
    BaseActivity.CloseOnInternetActivity {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       // setStatusBarHidden(this@NoInternetActivity)
        ...
        Glide.with(this@NoInternetActivity).load(R.raw.no_internet_conenction_image).into(activityNoInternetBinding!!.imageNoInternet)

        setCloseOnInternetActivity(this)

        activityNoInternetBinding!!.imgClose.setOnClickListener { finishAffinity() }
    }
