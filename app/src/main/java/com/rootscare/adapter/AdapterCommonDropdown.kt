...
//            }
            ...
            fun onBind(pos: Int) {
                Log.d(TAG, " true")
                local_position = pos
                if(local_position==dropdownList!!.size-1){
                    itemView?.rootView?.dropdown_item_view?.visibility=View.GONE
                }else{
                    itemView?.rootView?.dropdown_item_view?.visibility=View.VISIBLE
                }
